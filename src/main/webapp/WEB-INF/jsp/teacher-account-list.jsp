...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/teacher-account-list.css">
</head>
...
<body>
    ...
    <script src="${pageContext.request.contextPath}/js/teacher-account-list.js"></script>
</body>
